...
import fr.silenthill99.christmas_time.utils.ModTags;
...
public class BlockTagsGenerator extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        tag(BlockTags.MINEABLE_WITH_PICKAXE).add(ModBlocks.GINGERBREAD_SUGAR.get(), ModBlocks.TEST.get());
        tag(Tags.Blocks.NEEDS_NETHERITE_TOOL).add(ModBlocks.GINGERBREAD_SUGAR.get());
        tag(ModTags.ModBlockTags.NEEDS_BARLEY_TOOLS).add(ModBlocks.TEST.get());
    }
}
